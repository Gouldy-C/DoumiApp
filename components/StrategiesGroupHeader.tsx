...
const StrategiesGroupHeader = ({
    ...
    return (
      <View
        style={{
          ...
          borderRadius: 24,
          gap: 2,
          backgroundColor: getColor(groupIndex),
          overflow: "hidden",
        ...
        <View style={{ paddingHorizontal: 12, paddingVertical: 4, flex: 1 }}>
          ...
          <Text
            style={{ color: "white", fontSize: 30, flex: 1, paddingLeft: 12 }}>
            {strategyCatagories[groupIndex].title}
          </Text>
        </View>
        <View
          style={{
          ...
          <View
            ...
            <Image
              ...
              source={strategyCatagories[groupIndex].image}
            />
          </View>
        </View>
      </View>
  ...
  if (variant === "next") {
    groupIndex =
      groupIndex + 1 >= strategyCatagories.length ? 0 : groupIndex + 1;
    return (
      <View
        style={{
          width: "90%",
