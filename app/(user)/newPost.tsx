...
const NewPost = () => {
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white', paddingHorizontal: 20}}>
      ...
      <View style={{flex: 1, backgroundColor: 'white', alignSelf: "center",width: '100%'}}>
        <View style={{elevation: 0, backgroundColor: 'white', borderRadius: 8, justifyContent: 'space-between', alignSelf: "center", width: '100%',  marginVertical: 5, flex: 1, overflow: 'hidden'}}>
          <ControlledTextInput
      ...
      <View style={{}}>
        <Pressable
          ...
          style={{marginVertical: 10, flexDirection: 'row', width: 175, marginRight: 100}}
          >
          <View
        ...
        <DefaultPurpleButton disabled={false} styles={{paddingVertical: 8}} onPress={handleSubmit(submitData)}>
